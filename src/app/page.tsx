        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="block sm:hidden">
            <InfiniteLogoCarousel
              logos={[
                ...
                { src: "/logos/stc.png", alt: "STC", className: "h-16 w-auto object-contain opacity-60" },
                { src: "/logos/40.png", alt: "40", className: "h-22 w-auto object-contain opacity-60" },
              ]}
            />
          </div>
          ...
          <div className="hidden sm:flex justify-center items-center gap-3 md:gap-4 lg:gap-6">
            ...
            <Image
              ...
              width={200}
              height={200}
              className="h-26 md:h-28 lg:h-30 w-auto object-contain opacity-60 hover:opacity-100 transition-opacity duration-300"
            />
          </div>
        </div>
      </section>
          ...
          <div className="block sm:hidden">
            <InfiniteLogoCarousel
              logos={[
                ...
                { src: "/logos/maria.png", alt: "Maria", className: "h-8 w-auto object-contain opacity-40" },
          ...
          <div className="hidden sm:flex justify-center items-center gap-4 md:gap-6 lg:gap-8">
            ...
            <div className="flex items-center justify-center h-28 md:h-32 lg:h-36">
              <Image 
                ...
                width={200}
                height={200}
                className="h-14 md:h-18 lg:h-20 w-auto object-contain opacity-40 hover:opacity-60 transition-opacity duration-300"
              />
            </div>
            <div className="flex items-center justify-center h-28 md:h-32 lg:h-36">
              <Image 
